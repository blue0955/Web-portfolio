...
<section id="bo_w">
    ...
    <div class="form_01">
		<div class="bo_w_ico write_div">
			...
			<div class="bo_w_ico write_div">
				<label for="qa_category"  class="lb_icon"><span class="sound_only"> 분류<strong>필수</strong></span></label>
				<select name="qa_category" id="qa_category" required class="frm_input full_input required">
