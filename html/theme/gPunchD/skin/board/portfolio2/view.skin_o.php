...
<div class="wstPFtop">
	<?php if($youtubeThumbL){?><i style="background-image:URL(<?php echo $youtubeThumbL; ?>);"></i><?php } ?>
	<i style="background-image:URL(<?php echo $thumb['src']; ?>);"></i>
	<h2>
		<small>
		...
		<u>
			<!-- 조회수, 작성일은 관리자만 확인 가능 -->
			<span class="sound_only">작성자</span> <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong> <em>|</em>
