...
if ($is_admin) {}  else { 
?>
<script> location.href = "<?php echo $write_href ?>"; </script>
<?php 
}
?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">연락처</span><strong><i class="fa fa-phone" aria-hidden="true"></i> <?php if($view['wr_1']){ echo $view['wr_1']; } else { echo '입력된 연락처가 없습니다.'; } ?></strong> 
        <span class="sound_only">이메일</span><strong><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php if($view['wr_email']){ echo $view['wr_email']; } else { echo '입력된 이메일이 없습니다.'; } ?></strong>
    </section>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
           ...
           <li><a href="<?php echo $list_href ?>" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 등록폼 보기</a></li><?php } ?>
        </ul>

        <?php if ($prev_href || $next_href) { ?>
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li class="btn_prev transOJ"><a href="<?php echo $prev_href ?>"><i class="xi-long-arrow-left" aria-hidden="true"></i> <span class="sound_only"> 이전글</span> <b><?php echo $prev_wr_subject;?> </b></a> </li><?php } ?>
            <?php if ($next_href) { ?><li class="btn_next transOJ"> <a href="<?php echo $next_href ?>"><i class="xi-long-arrow-right" aria-hidden="true"></i> <span class="sound_only">다음글 </span> <b><?php echo $next_wr_subject;?> </b></a> </li><?php } ?>
        </ul>
        <?php } ?>
        <?php
