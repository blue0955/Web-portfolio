...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="likeTbl">
        ...
        <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> likeTblTr likeTblTd">
            ...
            <div class="mvInlinev td_name"><i class="fa fa-phone"></i> <?php echo $list[$i]['wr_1'] ?></div>
            <div class="mvInlinev td_num"><i class="fa fa-envelope-o"></i> <?php echo $list[$i]['wr_email'] ?></div>
