...
<section id="bo_w">
	...
	<div class="formWr">
		<div class="formLeft">
			<div>
				<!-- <strong><?php if($admin['mb_tel']){ echo '  Tel. '.$admin['mb_tel'].'</span>';} else echo '<span>관리자정보 전화번호 입력</span>';?> </strong> -->
				<!-- <span><?php if($admin['mb_email']){ echo  '  E-mail. '; ?><a href='mailto:<?php echo $admin['mb_email']?>'><?php echo $admin['mb_email']?></a></span><?php } else echo '<span>관리자정보 이메일 입력</span>';?> </span> -->
			</div>
		</div>
		<div class="formRight">
			<!-- 게시물 작성/수정 시작 { -->
