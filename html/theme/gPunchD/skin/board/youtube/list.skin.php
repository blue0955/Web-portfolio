            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_boxa">
						...
						<?php
                            $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], 600, 338, false, true);
                            ...
                            if(isset($thumb['src']) && $thumb['src']) {
								...
								if(isset($youtubeID1[2]) && $youtubeID1[2] == "youtu.be") {
									$img_content = '<i class="youtube_img"><sup style="background-image:URL(//img.youtube.com/vi/'.$youtubeID1[3].'/maxresdefault.jpg);"" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=338" alt="youtube image spacer"></i></sub></i>
								';
								} 
									...
									if(isset($youtubeID1[2]) && $youtubeID1[3] == "shorts" || $youtubeID1[3] == "live") {
										...
										$img_content = '<i class="youtube_img"><sup style="background-image:URL(//img.youtube.com/vi/'.$youtubeIDnew[$i][0].'/maxresdefault.jpg);"" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=338" alt="youtube image spacer"></i></sub></i>
									';
									} else {
										$youtubeIDnew[$i] = explode('=',$youtubeID1[3]); 
										$youtubeIDnewID[$i] = explode('&',$youtubeIDnew[$i][1]); 
										$img_content = '<i class="youtube_img"><sup style="background-image:URL(//img.youtube.com/vi/'.$youtubeIDnewID[$i][0].'/maxresdefault.jpg);"" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=338" alt="youtube image spacer"></i></sub></i>
									';
									...
									if($board['bo_gallery_height'] == 0){
										$img_content = '<i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=600" alt="이미지 없음"></i><b><i class="fa fa-picture-o"></i><!-- 이미지 없음 --></b>';
									} else {
										$img_content = '<i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w=600&h=338" alt="이미지 없음"></i><b><i class="fa fa-picture-o"></i><!-- 이미지 없음 --></b>';
									}
								}
                            }
