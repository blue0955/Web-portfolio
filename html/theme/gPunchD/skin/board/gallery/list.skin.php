...
<!-- 게시판 목록 시작 { -->
<div id="bo_gallWst" style="width:<?php echo $width; ?>">
						...
						<?php
                            ...
                            if(isset($thumb['src']) && $thumb['src']) {
								...
								if(isset($youtubeID1[2]) && $youtubeID1[2] == "youtu.be") {
									$img_content = '<i class="youtube_img"><sup style="background-image:URL(//img.youtube.com/vi/'.$youtubeID1[3].'/maxresdefault.jpg);"" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w='.$board['bo_gallery_width'].'&h='.$board['bo_gallery_height'].'" alt="youtube image spacer"></i></sub></i>
								';
								} 

								else if(isset($youtubeID1[2]) && $youtubeID1[2] == "youtube.com" ||  $youtubeID1[2] == "youtube.com" || $youtubeID1[2] == "www.youtube.com") {
									if(isset($youtubeID1[2]) && $youtubeID1[3] == "shorts" || $youtubeID1[3] == "live") {
										$youtubeIDnew[$i] = explode('?',$youtubeID1[4]); 
										$img_content = '<i class="youtube_img"><sup style="background-image:URL(//img.youtube.com/vi/'.$youtubeIDnew[$i][0].'/maxresdefault.jpg);"" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w='.$board['bo_gallery_width'].'&h='.$board['bo_gallery_height'].'" alt="youtube image spacer"></i></sub></i>
									';
									} else {
										$youtubeIDnew[$i] = explode('=',$youtubeID1[3]); 
										$youtubeIDnewID[$i] = explode('&',$youtubeIDnew[$i][1]); 
										$img_content = '<i class="youtube_img"><sup style="background-image:URL(//img.youtube.com/vi/'.$youtubeIDnewID[$i][0].'/maxresdefault.jpg);"" alt="'.$list[$i]['subject'].'"></sup><sub><i class="imgAr"><img src="'.G5_THEME_URL.'/plugin/websiting/imageSpacer.php?w='.$board['bo_gallery_width'].'&h='.$board['bo_gallery_height'].'" alt="youtube image spacer"></i></sub></i>
									';
